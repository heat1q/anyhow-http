/// Construct an ad-hoc [`Error`](anyhow::Error) from a status code, optional source error and formatted reason.
///
/// ```
/// # use anyhow::anyhow;
...
/// Shorthand macro to return early with an [`Error`](anyhow::Error).
///
/// Example:
/// ```
